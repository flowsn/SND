...
export const chapters: Chapter[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ['Reihe 2 erzeugt eine analoge Spannung und MIDI-Velocity. Im Normalmodus sind die Endwerte 1 und 127, die Klickposition in der Mitte liegt wegen mechanischer Toleranzen etwa bei 62–64. Add In wird zur Reglereinstellung addiert; 0–5 V entsprechen bei vollem Abschwächer dem beschriebenen Velocity-Bereich.', 'Row 2 produces an analog voltage and MIDI velocity. In Normal mode its endpoints are 1 and 127; mechanical tolerances put the click position in the middle around 62–64. Add In is added to the knob setting; at full attenuator setting, 0–5 V corresponds to the described velocity range.'],
